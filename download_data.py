...
def download_and_extract():
    ...
    # Dentro de 'data' pode haver outro arquivo zip contendo student-mat.csv e student-por.csv
    # Vamos verificar se student.zip está em data/ e extraí-lo também
    ...
    # Remover o zip temporário principal
